...
#------------------------Forecast------------------------
# GARCH forecast
igjrgarchfit <- ugarchfit(data=xli, spec=igjrgarchspec, out.sample = 22)
igjrgarchforecast <- ugarchforecast(fitORspec=igjrgarchfit, n.ahead=22, n.roll=22)
print(igjrgarchforecast)
# VaR based on predicted returns
VaR.predict.i <- as.numeric(quantile(igjrgarchforecast,probs=.05))
